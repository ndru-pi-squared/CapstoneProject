...
namespace Com.Kabaj.TestPhotonMultiplayerFPSGame
{
    ...
    public class PlayerManager : MonoBehaviourPunCallbacks, IPunObservable, ITarget
    {
        ...
        void ProcessInputs()
        {
            ...
            //press a button and change the other one back to active weapon
            /*if (Input.GetButton("Weapon1")) //Adding this option seems like the next step. Going to look more into a polymorphic solution to handle the input rather than long if statements. code will be so much easier to maintain
            {
