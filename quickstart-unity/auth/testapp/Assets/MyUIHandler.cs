...
namespace Firebase.Sample.Auth
{
    ...
    public class MyUIHandler : MonoBehaviour
    {
        ...
        // Alex: Variables linked up in unity
        public InputField emailInputField;
        public InputField passwordInputField;
        public Text emailText; // tied to email input field
        public Text passwordText; // tied to password input field
        public Text myLogText;
        ...
        public void SetEmail()
        {
            ...
            Debug.Log($"SetEmail(): email = {email}");
        }

        public void SetPassword()
        {
            password = passwordText.text.ToString();
            Debug.Log($"SetPassword(): password = {password}");
        }
        ...
        protected void InitializeFirebase()
        {
            ...
            {
                // Alex: Try to create a secondary authentication object
                try
                {
                    otherAuth = Firebase.Auth.FirebaseAuth.GetAuth(Firebase.FirebaseApp.Create(
                      otherAuthOptions, "Secondary"));
                    otherAuth.StateChanged += AuthStateChanged; //Alex: add an event handler (I think)
                    otherAuth.IdTokenChanged += IdTokenChanged; //Alex: add an event handler (I think)
                }
                catch (Exception)
                {
            ...
            // Alex: Push a notification to event handler
        ...
        public void DebugLog(string s)
        {
            ...
            //Alex: If logText is too big...
            while (logText.Length > kMaxLogSize)
            {
                //Alex: remove a line of text
        ...
        public Task CreateUserWithEmailAsync()
        {
            ...
            //Alex: added this to figure out a null pointer-ish exception
            if (auth == null) { Debug.Log("OOOPS!"); }
        ...
        void GUIDisplayLog()
        {
            ...
            myLogText.text = logText;
        }

        //Alex: This method is not in use anymore but I keep it around to see how it handled various button presses
        ...
        void GUIDisplayControls()
        {
            if (UIEnabled)
            {
                ...
                // Alex: Create custom button
                if (GUILayout.Button("Do Something cool!"))
                {
                    Debug.Log("Did something cool");
                    // Removes all displayed components but not gui skin
                    // UIEnabled = false;
                    //OffGui();
                    GUILayout.Button("Do Something cool!");
        ...
        public void HandleCreateUserButtonPress()
        {
            email = emailInputField.text;
            password = passwordInputField.text;
            DebugLog($"\nHandleCreateUserButtonPress(): email = {email}, password = {password}");
        ...
        public void HandleSignInButtonPress()
        {
            email = emailInputField.text;
            password = passwordInputField.text;
            DebugLog($"\nHandleSignInButtonPress(): email = {email}, password = {password}");

            SigninWithEmailAsync();
        }

        public void HandleSignOutButtonPress()
        {
            email = emailInputField.text;
            password = passwordInputField.text;
        ...
        public void HandleCloseMenuButtonPress()
        {
        ...
        public void HandleOpenMenuButtonPress()
        {
